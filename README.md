...
> **Support this project via Sponsorware**

WorkflowWiz is available as **Sponsorware**: it's free to use, but new features are reserved for sponsors. If you want access to exclusive features, [become a sponsor](https://github.com/sponsors/sdotwinter)!

### Sponsor Tiers

| Tier | Price | Features |
|------|-------|----------|
| 🭐 Supporter | $5/mo | Access to private screencasts, priority support |
| 🚀 Insider | $14/mo | All Supporter features + exclusive workflow templates, early access to new features |
| 🏢 Enterprise | $49/mo | All Insider features + custom workflow integrations, dedicated support channel |
